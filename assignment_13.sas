...
title1 'Fisher Ankney';
title2 'Assignment 13';

/* Question 1 */

title3 'Question 1';

/* Download Mesonet b/c old one was sorted */

PROC IMPORT OUT = WORK.january2018 
            DATAFILE= "C:\Users\fankney\Downloads\Assign10 Data.xlsx"
            DBMS=EXCEL REPLACE;
     RANGE="Jan2018$"; 
     GETNAMES=YES;
     MIXED=YES;
...
PROC IMPORT OUT = WORK.february2018 
            DATAFILE= "C:\Users\Fankney\Downloads\Assign10 Data.xlsx"
            DBMS=EXCEL REPLACE;
     RANGE="Feb2018$"; 
     GETNAMES=YES;
...
PROC IMPORT OUT = WORK.march2018  
            DATAFILE= "C:\Users\Fankney\Downloads\Assign10 Data.xlsx"
            DBMS=EXCEL REPLACE;
     RANGE="March2018$"; 
     GETNAMES=YES;
...
PROC IMPORT OUT = WORK.april2018  
            DATAFILE= "C:\Users\Fankney\Downloads\Assign10 Data.xlsx"
            DBMS=EXCEL REPLACE;
     RANGE="April2018$"; 
     GETNAMES=YES;
...
libname CLASS 'C:\Users\Fankney';

data CLASS.MESO2018_2;
	set january2018 february2018 march2018 april2018;
run;



data CLASS.MESO2018_2;
	set CLASS.MESO2018_2;
	label 
	day = "Day of the Month"
	RAIN_IN = "Rainfall Total"
	STNPRESSUR = "Pressure"
	SOLAR_MJ_M2 = "Solar Radiation"
	SODSOIL = "Average Soil Temp Under Veg"
	BARESOIL = "Average Soil Temp Bare"
	;
...
data MESO2018;
	...
	SPEEDAVG = "Average Wing Speed"
	;
run;


data class.mesonet;
	merge MESO2018 CLASS.MESO2018_2;
run;
...
proc gplot data = class.mesonet;
	plot maxtemp * doy;
	symbol1 value = none I = join;
	title3 'Question 2 max temp';
run;
...
proc gplot data = class.mesonet;
	PLOT (maxtemp mintemp) * doy / OVERLAY legend = legend1;
	symbol1 interpol=join value = none l=1 c=green;
	symbol2 interpol=join value = none l=3 c=red;
	title3 'Question 3';
run;
...
proc gchart data = class.mesonet;
	hbar month / type=mean sumvar=maxtemp;
	pattern1 color = green value = empty;
	title3 'Question 4a';
run;
...
proc gchart data = class.mesonet;
	hbar month / type=mean sumvar=maxtemp autoref nostats;
	pattern1 color = cyan value = solid;
	title3 'Question 4b';
run;
...
proc gchart data = class.mesonet;
	hbar month / type=mean sumvar=maxtemp autoref clipref nostats;
	pattern1 color = cyan value = solid;
	title3 'Question 4c';
run;
...
/* Returning to Question 5a */

/* vertical bar height = mean num field goals bars are each team 
where team = okc miami, dallas, denver */

proc gchart data = classhw.bball2017_18;
	where team = 'Oklahoma City Thunder' or 
		  team = 'Miami Heat' or 
		  team = 'Dallas Mavericks' or
		  team = 'Denver Nuggets';
	vbar team / discrete sumvar=fg type=mean group=year patternid = midpoint;
	pattern1 color = cyan value = solid;
	pattern2 color = gray value = solid;
	pattern3 color = purple value = solid;
	pattern4 color = cyan value = solid;
	title3 'Question 5a';
run;
...
proc gchart data = classhw.bball2017_18;
	vbar year / discrete sumvar=fg type=mean group=team patternid = group;
	where team = 'Oklahoma City Thunder' or 
		  team = 'Miami Heat' or 
		  team = 'Dallas Mavericks' or
		  team = 'Denver Nuggets';
...
proc gchart data = classhw.bball2017_18;
	vbar year / discrete sumvar=fg type=mean group=team patternid = midpoint;
	where team = 'Oklahoma City Thunder' or 
		  team = 'Miami Heat' or 
		  team = 'Dallas Mavericks' or
		  team = 'Denver Nuggets';
