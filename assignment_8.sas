...
PROC CORR DATA=mesonet18 PEARSON plots = scatter; 
	by Month;
	where Month = 'Feb' or Month = 'Mar';
	var MINTEMP MAXTEMP;
	with MINHUMID MAXHUMID;
	title 'Question 1';
run;
...
data nba;
	...
	if team= 'Toronto Raptors' 
		...
		or team='Miami Heat' or 
		team='Atlanta Hawks' or 
		team='Washington Wizards' or 
		team='Charlotte Hornets' or 
		team='Orlando Magic' 
