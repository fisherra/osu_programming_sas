...
libname classhw 'C:\Users\fankney\Documents';

data classhw.mesonet18 ;
...
proc report data = classhw.mesonet18;
    columns Month MAXTEMP MAXHUMID;
    define Month / group "Month";
    define MAXTEMP / mean "Mean Daily Max Temp";
    define MAXHUMID / mean "Mean Daily Max Humid";
    title3 'Question 1b';
run;
...
filename arch 'C:\Users\fankney\Documents\architecture.txt';
...
proc gchart data = classhw.arch;
    pie int / type=percent;
    title3 'Question 2b';
run;
...
data question_3;
    title3 'Question 3';
    a_lower_bounds = 94.22 - (tinv(0.97,17)*(6.9/sqrt(18)));
    a_upper_bounds = 94.22 + (tinv(0.97,17)*(6.9/sqrt(18)));
    b = 1-probf(4.47,4,14);
run;

proc print data = question_3;
run;
