...
proc gchart data = nba_full;
      by year;
      vbar P3 / axis = 0 12 midpoints = 6 8 10 12 14 16 18;
      title3 "Question 1a";
run;
 
 
proc gchart data = nba_full;
      vbar P3 / group= year midpoints = 5 7 9 11 13 15;
      title3 "Question 1b";
run;
 
 
proc gchart data = nba_full;
      vbar year / sumvar=P3 type=mean;
      title3 "Question 1c";
run;
 
 
 
proc ttest data = nba_full alpha = 0.02 plots=(histogram boxplot);
      class conference;
      by year;
      var ft;
      title3 "Question 2a";
...
proc ttest data = nba_full alpha = 0.01 plots(only)=(boxplot interval profiles);
      where year = 2017 and conference = "west";
      paired P3*FT;
      title3 "Question 2b";
run;
